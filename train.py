...
def main(args):
  ...
  #  terminate_on_nan = TerminateOnNaN()
   ...
   # callbacks=[logging, checkpoint, reduce_lr, early_stopping, terminate_on_nan]
    ...
    #if args.eval_online:
       # eval_callback = EvalCallBack(args.model_type, dataset[num_train:], anchors, class_names, args.model_image_size, args.model_pruning, log_dir, eval_
   
   
   #_interval=args.eval_epoch_interval, save_eval_checkpoint=args.save_eval_checkpoint, elim_grid_sense=args.elim_grid_sense)
  ...
  #      callbacks = callbacks + pruning_callbacks
   ...
   # else:
    ...
    model.save(os.path.join(log_dir, 'trained_final2.h5'))
