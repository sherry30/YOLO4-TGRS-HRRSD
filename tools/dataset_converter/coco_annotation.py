...
new_data_path = "D:/Assignments/deepLearning/data/TGRS-HRRSD-Dataset-mstr-gthb/OPT2017/JPEGImages"
...
for dataset, datatype in sets:
    ...
    coco_annotation_file = open(dataset_realpath,
                           encoding='utf-8')
    ...
    if args.include_no_obj:
        ...
        for image in images:
            ...
            # }
            image_id = image['id']
            image_file = '%s/%s/%05d.jpg' % (new_data_path, datatype, image_id)
    ...
    for annotation in annotations:
        ...
        image_file = "%s/%05d.jpg" % (new_data_path, image_id)
    ...
    annotation_file = open('%s.txt'%(args.output_path), 'w')
